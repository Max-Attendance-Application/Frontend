...
const AdminManagementuserProfileEdit = () => {
    ...
    const dataDummy = {
        ...
        photo: '/assets/images/heeseung_satu (1).png',
    ...
    const [formData, setFormData] = useState(dataDummy)
...
export default AdminManagementuserProfileEdit